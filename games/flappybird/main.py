...
def gameStart():
    ...
    current_path_bg = os.getcwd()
    current_path_bg = os.path.join(currentPath, 'background.png')
    

    # 새
    current_path_fb = os.getcwd()
    current_path_fb = os.path.join(current_path_fb, 'main_bird.png')
    ...
    def collision_detection1(obstacle_1_x_pos, obstacle_1_height, bird_y_pos, bottom_1_y):
       if 150 <= obstacle_1_x_pos <= (150 + 80): # 기둥 사이에 있을 때:
    ...
    def collision_detection2(obstacle_2_x_pos, obstacle_2_height, bird_y_pos, bottom_2_y):
       if 150 <= obstacle_2_x_pos <= (150 + 80): # 기둥 사이에 있을 때:
