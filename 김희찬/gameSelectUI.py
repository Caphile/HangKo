    ...
    while running:
        ...
        for i in range(gamePerPage):
            ...
            if int((i * 2) / gamePerPage) % 2 == 0: # 게임 목록 중 첫번째 줄
                ...
                gameBox.append(pg.draw.rect(gsDis, c.GRAY, ((c.winWidth - gameListPanelWidth) / 2 + stand * gameBoxWidth + (stand + 1) * leftMargin, topMargin * 3 + gameBoxHeight, 
                                                            gameBoxWidth, gameBoxHeight), 1))
